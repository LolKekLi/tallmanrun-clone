...
public class RopeController : MonoBehaviour
{
    ...
    public void UpdateRope(Transform startingPosition, Transform endingPosition,
        CylinderGeneration cylinderGeneration, string meshName)
    {
    ...
    public void UpdateRope(Transform startingPosition, Transform endingPosition,
        ClonePlayerCylinderGen cylinderGeneration, string meshName)
    {
        var direction = endingPosition.position - startingPosition.position;
        var magnitude = direction.magnitude;
        cylinderGeneration.GetUpdated(direction, magnitude, meshName);
